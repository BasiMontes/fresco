// Auto-generated by `bun run db:types` (mcp__supabase__generate_typescript_types /
// `supabase gen types typescript --project-id jdqemhewjrjuopssdurn`). Do not hand-edit —
// regenerate after every migration instead; manual edits are silently discarded on next run.
export type Json
  = | string
    | number
    | boolean
