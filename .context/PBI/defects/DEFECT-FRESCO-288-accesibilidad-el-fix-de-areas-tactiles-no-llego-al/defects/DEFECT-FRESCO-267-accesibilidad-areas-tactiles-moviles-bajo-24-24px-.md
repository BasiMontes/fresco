...
**Related Story:** [FRESCO-288](https://basiliomontescastano.atlassian.net/browse/FRESCO-288) - Accesibilidad: el fix de áreas táctiles no llegó al footer de auth ni al checkbox de `/signup`
**Priority:** Low
**Status:** Finalizada
**Components:** None
