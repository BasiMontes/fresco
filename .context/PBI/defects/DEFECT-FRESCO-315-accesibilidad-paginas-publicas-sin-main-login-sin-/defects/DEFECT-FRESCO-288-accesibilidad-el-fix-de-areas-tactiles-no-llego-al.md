...
**Related Story:** [FRESCO-315](https://basiliomontescastano.atlassian.net/browse/FRESCO-315) - Accesibilidad: páginas públicas sin <main>, /login sin <label>, targets <44px, robots 404, H2 roto
**Priority:** Medium
**Status:** Finalizada
**Components:** None
...
- relates to: [FRESCO-315](https://basiliomontescastano.atlassian.net/browse/FRESCO-315) - Accesibilidad: páginas públicas sin <main>, /login sin <label>, targets <44px, robots 404, H2 roto
