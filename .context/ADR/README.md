...
| [ADR-0010](./ADR-0010-postgres-atomic-counter-rate-limiting.md) | Rate limiting on Edge Functions via a Postgres atomic-counter table, no external dependency | Proposed | — | — |
