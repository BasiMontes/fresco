...
**Por qué**: pedido directo del user — primero FRESCO-31, después "el resto" del backlog (push pendiente, luego FRESCO-56, luego FRESCO-57 corrido de un tirón — "vamos de lujo hoy").

**Siguiente**: FRESCO-56 y FRESCO-57 en `Control de calidad` en Jira, commits `7e9835a`/`38009c1` pusheados a `main`. Quedan FRESCO-58 (estimaciones de ahorro semanal) y FRESCO-59 (últimas recetas añadidas) de la épica FRESCO-54, ambas "Listo"/sin bloqueos. FRESCO-31 sigue con 758/1000 restantes.
