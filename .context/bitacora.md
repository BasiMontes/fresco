...
**Por qué**: pedido directo del user — primero FRESCO-31, después "el resto" del backlog (push pendiente, luego FRESCO-56).

**Siguiente**: FRESCO-56 en `Control de calidad` en Jira, commit `7e9835a` pusheado a `main`. Quedan FRESCO-57 (cantidad de recetas disponibles), FRESCO-58 (estimaciones de ahorro semanal), FRESCO-59 (últimas recetas añadidas) de la épica FRESCO-54, todas "Listo"/sin bloqueos. FRESCO-31 sigue con 758/1000 restantes.
