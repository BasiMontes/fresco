...
**Por qué**: pedido directo del user — primero FRESCO-31, después "el resto" del backlog (push pendiente, luego FRESCO-56, FRESCO-57 y FRESCO-58 corridas de un tirón — "vamos de lujo hoy").

**Siguiente**: FRESCO-56/57/58 en `Control de calidad` en Jira, commits `7e9835a`/`38009c1`/`d306a35` pusheados a `main`. Queda FRESCO-59 (últimas recetas añadidas) de la épica FRESCO-54, sin bloqueos. FRESCO-31 sigue con 758/1000 restantes. Pendiente real de negocio (no de dev): validar las 3 cifras de FRESCO-58 con datos de mercado reales antes de sacar el aviso de "pendiente de revisión" de la UI.
