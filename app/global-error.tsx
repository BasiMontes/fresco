      ...
      <body>
        <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-12 text-center">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center justify-center gap-2 self-center rounded-full bg-primary px-6 py-3 text-label font-sans text-on-brand transition-colors hover:bg-accent-600"
          >
            Intentar de nuevo
          </button>
        </div>
