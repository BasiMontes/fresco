...
const BASE_QUANTITIES: Record<string, { cantidad: number; unidad: string }> = {
  ...
  calabacín: { cantidad: 1, unidad: 'unidades' },
  ...
  pimentón: { cantidad: 3, unidad: 'g' },
  comino: { cantidad: 2, unidad: 'g' },
  orégano: { cantidad: 2, unidad: 'g' },
