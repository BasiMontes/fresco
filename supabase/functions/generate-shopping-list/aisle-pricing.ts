...
const PRICE_OVERRIDE: Record<string, number> = {
  ...
  pan: 0.12,
  'pan rallado': 0.005,
  // Higher-value items — priced per gram/ml, matching the real unit
  // consolidator.ts's BASE_QUANTITIES now assigns them (full ingredient
  // coverage as of this pass), NOT a flat per-instance price. A flat
  // per-instance price here multiplied by a real 400-1000g quantity is
  // exactly the bug this comment exists to warn against re-introducing.
  salmon: 0.019,
  'salmon ahumado': 0.035,
  bacalao: 0.015,
  'bacalao desalado': 0.015,
  langostinos: 0.018,
  mejillones: 0.004,
  calamares: 0.012,
  jamon: 0.018,
  ...
  'jamon serrano': 0.018,
  'jamon cocido': 0.01,
  'queso parmesano': 0.025,
  parmesano: 0.025,
  'queso mozzarella': 0.01,
  'queso feta': 0.012,
  'queso crema': 0.008,
  ternera: 0.012,
  'ternera para guisar': 0.012,
  cordero: 0.014,
  conejo: 0.007,
  pavo: 0.008,
  'pechuga de pavo': 0.008,
  pollo: 0.005,
  'pollo troceado': 0.005,
  'muslos de pollo': 0.004,
  setas: 0.006,
  'setas shiitake': 0.01,
  almendras: 0.012,
  nueces: 0.01,
